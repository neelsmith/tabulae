...
object ValidForm {
  ...
  val labels : Map[String, String] = Map("urn:cite2:tabulae:morphforms.v1:00000000A" -> "uninflected conjunction",
  ...
  "urn:cite2:tabulae:morphforms.v1:000000309" -> "supine: dative",
