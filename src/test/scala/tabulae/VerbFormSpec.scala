...
class VerbFormSpec extends FlatSpec {
  ...
  "A  VerbForm" should "require PNTMV in constructor" in {
    val verbForm = VerbForm("facio", "ls.n17516","ocremorph.n17516b","livymorph.pftact_pft3", Third, Singular, Perfect, Indicative, Active)
    verbForm match {
  ...
  it should "be recognized as an instance of a Form" in {
    val form =  VerbForm("facio", "ls.n17516","ocremorph.n17516b","livymorph.pftact_pft3", Third, Singular, Perfect, Indicative, Active)
