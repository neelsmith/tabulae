...
//infinitiveinfl.w_pp3_aor_indic3b#w_pp3#e#3rd#sg#aor#indic#actj
//
...
// #sg#aor#indic#actj
      ...
      //<infinitive>
      // e/tw
      //<3rd><sg><aor><imptv><act><u>infinitiveinfl\.w\_pres\_imptv3</u>

      fst.append(s" <${inflClass}><infinitive>${inflString}<${pers}><${grammNumber}><${tense}><${mood}><${voice}><u>${ruleUrn}</u>").toString
    }
